...
public class RSA {
    ...
    public static String publicEncrypt(String content, String publicKey) throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, RSA.string2PublicKey(publicKey));
    ...
    public static String privateDecrypt(String contentBase64, String privateKey) throws Exception {
        Cipher cipher = Cipher.getInstance("RSA");
        cipher.init(Cipher.DECRYPT_MODE, RSA.string2PrivateKey(privateKey));
    ...
    public static void main(String args[]) throws Exception {
        String[] keyPairArr = RSA.genKeyPair();
        ...
        //
        String string = "测试明文小野小野小小野";

        String msg = RSA.publicEncrypt(string, keyPairArr[0]);
        System.out.println("加密后内容: " + msg);
        System.out.println();

        //
        String mms = RSA.privateDecrypt(msg, keyPairArr[1]);
