        ...
        <div class="nav-kuaijie yjp-hover1 f-l">
            ...
            <div class="kuaijie-box yjp-show1" style="display:none;">
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="${pageContext.request.contextPath}/images/zl2-07.gif"/><a href="搜索列表(有品牌).html">食品/饮料/酒水</a>
                        </dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="${pageContext.request.contextPath}/images/zl2-08.gif"/><a href="搜索列表(有品牌).html">粮油副食</a>
                        </dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="${pageContext.request.contextPath}/images/zl2-09.gif"/><a href="搜索列表(有品牌).html">家庭清洁</a>
                        </dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="${pageContext.request.contextPath}/images/zl2-10.gif"/><a href="搜索列表(有品牌).html">美妆洗护/个人护理</a>
                        </dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="${pageContext.request.contextPath}/images/zl2-11.gif"/><a href="搜索列表(有品牌).html">母婴用品/玩具</a>
                        </dt>
                        <dd>
                ...
                <div class="kuaijie-info">
                    <dl class="kj-dl1">
                        <dt><img src="${pageContext.request.contextPath}/images/zl2-12.gif"/><a href="搜索列表(有品牌).html">家居/家电</a>
                        </dt>
                    </dl>
                    <div class="kuaijie-con">
                        <dl class="kj-dl2">
...
<div class="personal w1200">
    <div class="personal-left f-l">
        ...
        <ul>
            ...
            <li class="per-li2"><a href="/shop/user/personal">个人资料<span>></span></a></li>
    ...
    <div class="order-right f-r">
        <div class="order-hd">
            <dl class="f-l">
                ...
                <dd>
                    <h3><a href="#">用户名：<span style="color: #129FE9">${user.username}</span></a></h3>
                    <p>TEL：&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #129FE9">${user.phone}</span></p>
                </dd>
                <div style="clear:both;"></div>
            </dl>
                        ...
                        <div class="dai-con">
                            <dl class="dl1">
                                <dt>
                                    ...
                                    <a href="/shop/product/toproduct?pId=${list.product.pId}" class="f-l"><img
                    ...
                    <div style="float: right;font-size: large;margin-right: 7%">
                        ...
                        <c:choose>
                            <c:when test="${orderExt.state==0}">
                                <p><a href="${pageContext.request.contextPath}/order/doPay2?oId=${orderExt.oId}&state=1" id="qfk">去付款</a> <a  href="${pageContext.request.contextPath}/order/updatastate?oId=${orderExt.oId}&state=-1" name="delOrder">删除</a></p>

                            </c:when>
                            <c:when test="${orderExt.state==1}">
<%--                                <p onclick="alert('已提示卖家')">提醒发货</p>--%>
                                <button type="button" class="btn" onclick="alert('商家正在火速备货');window.location.href='${pageContext.request.contextPath}/order/updatastate?oId=${orderExt.oId}&state=2'">提醒发货</button>
